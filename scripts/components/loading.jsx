...
// Loading style from http://codepen.io/colortom/pen/ciGLC
var Loading = React.createClass({
  componentWillReceiveProps: function(props) {
    !props.active && this.setState({loading: false});
  },
  ...
  render: function() {
    return <svg version="1.1" className={'loading-wrapper ' + (this.state.loading ? '' : 'finished')}
                xmlns="http://www.w3.org/2000/svg" xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"
                width="273px" height="125.2px" viewBox="0 0 273 125.2" enable-background="new 0 0 273 125.2" space="preserve">
      <path className="path" fill="none" stroke="#000000" strokeWidth="4" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round" d="
      ...
      <path fill="none" className="path-2" stroke="#000000" strokeWidth="4" strokeLinecap="round" strokeLinejoin="round" strokeMiterlimit="10"
